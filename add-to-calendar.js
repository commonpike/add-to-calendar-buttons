;(function(exports) {
  ...
  var calendarGenerators = {
    ...
    dOutlook: function(event) {
      return this.ics(event, 'icon-outlook', CONFIG.texts.dOutlook);
    }
  };
  ...
  var generateCalendars = function(event) {
    return {
      ...
      dOutlook: calendarGenerators.dOutlook(event)
    };
  };
